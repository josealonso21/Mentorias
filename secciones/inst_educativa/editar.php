...
if(isset($_GET['txtID'])){
    ...
    $sentence=$con->prepare("SELECT * FROM insteducativa WHERE InstEducativaID=:InstEducativaID");
...
if($_POST){
    ...
    $sentence=$con->prepare("UPDATE insteducativa SET InstEducativaID=:InstEducativaID,Nombre=:Nombre,Ubicacion=Ubicacion WHERE InstEducativaID=:InstEducativaID");
    $sentence->bindParam(":InstEducativaID",$txtID);
